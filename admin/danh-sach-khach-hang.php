        ...
        <tbody>
          ...
          ?>
                <tr>
                  ...
                  <td>
                    <form action="sua-khachhang.php" method="post">
                  ...
                  <td>
                    <form action="code.php" method="post">
                      <input type="hidden" name="delete_khachhang" value="<?php echo $row['MaKH']; ?>">
                      <button type="submit" name="btn_delete_khachhang" class="btn btn-danger"><i class="fas fa-ban"></i></button> 
                    </form>
                  </td>
                </tr>
          <?php
